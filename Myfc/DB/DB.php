...
namespace Myfc;
 ...
 class DB
 {
      ...
      *   Baþlatýcý Fonksiyon
      *
      *   Seçilen tabloyu parametre olarak $table ile iletebilir, veya herhangi bir sýnýftan çekebilirisniz
      *
      */
     ...
     /**
      * Sýnýftaki deðerleri kullanýma hazýrlar, notice hatalarýný önler
      */
     ...
     private function connect()
     {
         ...
         if(isset($configs['Connections'][$connect]))
         {
             ...
             throw new Exception('yanlýþ sürücü seçilmiþ'.static::CONFIG_PATH.' dosyasýnda bulunamadý');
      ...
      * @return $this
      *
      *  Sýnýfa yeni bir connector ekler
      *
      */
     ...
     /**
      *
      *  Sýnýfýn kullacaðýný driver ý seçer
      *
      * @param string $name
      * @return $this|bool
      */
     ...
     */
     ...
     /**
      *
      * 3 deðer alan diziyi 2 e düþürür
      * @param $array
      * @return array
      *
      */
